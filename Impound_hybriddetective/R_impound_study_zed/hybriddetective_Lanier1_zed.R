...
setwd("/Users/andrewtaylor/Desktop/R_Projects/R_impound_study/R_impound_study_zed/Lanier1/")
path.hold <-getwd()
...
freqbasedsim_GTFreq(GenePopData ="/Users/andrewtaylor/Desktop/R_Projects/R_impound_study/R_impound_study_zed/Lanier1/Lanier1_ref_for_hybriddetective_copy.txt", 
                        NumSims = 3, 
                        NumReps = 3,
                        sample.sizePure = 50,
                        sample.sizeF1 = 50,
                        sample.sizeF2 = 50,
                        sample.sizeBC = 50,
                        pop.groups = c("SHB", "ALB"))

####NOTE:  Cut and past the simulated files out of the inputs and back into the Lanier1 folder!
...
write.table(x = Zeds_simulated, file = "/Users/andrewtaylor/Desktop/R_Projects/R_impound_study/R_impound_study_zed/Lanier1_inputs/SimZeds.txt", row.names = FALSE, col.names = TRUE, quote = FALSE)
write.csv(Zeds_simulated, file = "/Users/andrewtaylor/Desktop/R_Projects/R_impound_study/R_impound_study_zed/Lanier1_inputs/SimZeds.csv", row.names = FALSE, quote = FALSE)

###Applies the saved zed file across the simulations to be run by newhybrids
nh_Zcore(GetstheZdir = "/Users/andrewtaylor/Desktop/R_Projects/R_impound_study/R_impound_study_zed/Lanier1/",
multiapplyZvec = "/Users/andrewtaylor/Desktop/R_Projects/R_impound_study/R_impound_study_zed/Lanier1_inputs/SimZeds.csv")
...
parallelnh_OSX("/Users/andrewtaylor/Desktop/R_Projects/R_impound_study/R_impound_study_zed/Lanier1/", 
...
nh_preCheckR(PreDir="/Users/andrewtaylor/Desktop/R_Projects/R_impound_study/R_impound_study_zed/Lanier1/NH.Results/", propCutOff = 0.5, PofZCutOff = 0.1)
...
nh_multiplotR(NHResults="/Users/andrewtaylor/Desktop/R_Projects/R_impound_study/R_impound_study_zed/Lanier1/NH.Results/")
...
hybridPowerComp(dir="/Users/andrewtaylor/Desktop/R_Projects/R_impound_study/R_impound_study_zed/Lanier1/NH.Results/", samplesize = c(50,50,50,50,50,50))
...
nh_analysis_generateR(
  ReferencePopsData = "/Users/andrewtaylor/Desktop/R_Projects/R_impound_study/R_impound_study_zed/Lanier1/Lanier1_ref_for_hybriddetective_copy_S2R2_NH.txt",
  UnknownIndivs = "/Users/andrewtaylor/Desktop/R_Projects/R_impound_study/R_impound_study_zed/Lanier1_inputs/Lanier1_wild_for_hybriddetective.txt",
  output.name = "NH_Lanier1_assignments_final_output.txt")
...
###Applies the saved zed file across the simulations to be run by newhybrids
nh_Zcore(GetstheZdir = "/Users/andrewtaylor/Desktop/R_Projects/R_impound_study/R_impound_study_zed/Lanier1/Combined/",
         multiapplyZvec = "/Users/andrewtaylor/Desktop/R_Projects/R_impound_study/R_impound_study_zed/Lanier1_inputs/SimZeds.csv")


###Run NewHybrids on the combined data
parallelnh_OSX("/Users/andrewtaylor/Desktop/R_Projects/R_impound_study/R_impound_study_zed/Lanier1/Combined/", 
               where.NH = "/Users/andrewtaylor/newhybrids/", 
               burnin = 500000, 
               sweeps = 1000000)

#check for convergence
nh_preCheckR(PreDir="/Users/andrewtaylor/Desktop/R_Projects/R_impound_study/R_impound_study_zed/Lanier1/Combined/NH.Results/", propCutOff = 0.5, PofZCutOff = 0.1)

###Visualize results
###First shows pure 1 (blue) and pure 2 (red) from simulated pops, then unknown individuals
nh_plotR("/Users/andrewtaylor/Desktop/R_Projects/R_impound_study/R_impound_study_zed/Lanier1/Combined/NH.Results/NH_Lanier1_assignments_final_output.txt_Results/NH_Lanier1_assignments_final_output.txt_PofZ.txt")

###Plotting both ways so plot can be saved with colors that match original simulations for the system
nh_plotR("/Users/andrewtaylor/Desktop/R_Projects/R_impound_study/R_impound_study_zed/Lanier1/Combined/NH.Results/NH_Lanier1_assignments_final_output.txt_Results/NH_Lanier1_assignments_final_output.txt_PofZ.txt", ReversePure = 1)
nh_plotR("/Users/andrewtaylor/Desktop/R_Projects/R_impound_study/R_impound_study_zed/Lanier1/Combined/NH.Results/NH_Lanier1_assignments_final_output.txt_Results/NH_Lanier1_assignments_final_output.txt_PofZ.txt", ReversePure = 2)
